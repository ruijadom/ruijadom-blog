...
const SidebarContextContext = React.createContext<SidebarContext | null>(null);

function useSidebar() {
  const context = React.useContext(SidebarContextContext);
  if (!context) {
...
>(
  (
    ...
    return (
      <SidebarContextContext.Provider value={contextValue}>
